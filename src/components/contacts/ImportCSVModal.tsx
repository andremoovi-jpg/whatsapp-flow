...
export function ImportCSVModal({ open, onOpenChange }: ImportCSVModalProps) {
  ...
  const handleFileUpload = async (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    try {
      ...
      toast({
        ...
        description: 'O arquivo não pôde ser processado. Verifique se é um CSV válido.',
        variant: 'destructive',
      });
    }
  };
  ...
  const handleImport = async () => {
    ...
    const { imported, updated, errors } = { imported: 0, updated: 0, errors: 0 };
          ...
          <div className="space-y-6 py-4">
            ...
            <div className="text-sm text-muted-foreground">
              ...
              <ul className="list-disc list-inside space-y-1">
                ...
                <li>Tags podem ser separadas por vírgula</li>
              </ul>
            </div>
          </div>
        )}
          ...
          <div className="space-y-6 py-4">
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-2">
                <Label>Adicionar tags aos importados</Label>
                ...
                <div className="flex gap-2">
                  ...
                  />
                  <Button type="button" variant="outline" onClick={() => addImportTag(newTag)}>
                    Adicionar
                  </Button>
                </div>
              </div>
